...
<td>
<a class="btn btn-primary" href="logic.php?edit=<?php echo $row['id']; ?>">Edit</a>
<a class="btn btn-danger" href="logic.php?delete=<?php echo $row['id']; ?>">Delete</a>
